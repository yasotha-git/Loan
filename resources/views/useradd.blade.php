                    ...
                    <div class="row" style="margin-top: 34px;">
                        ...
                        <div class="col-lg-6">
                            <div class="single-form">
                                ...
                                <input type="text" name="mobileno" placeholder="Enter Number" value="{{ old('mobileno') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 23px;">
                        ...
                        <div class="col-lg-3">
                            <div class="single-form">
                                ...
                                <input type="date" name="dob" class="form-control" value="{{ old('dob') }}" style="margin-left: 145px;
    margin-top: -32px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 34px;">
                        ...
                        <div class="col-md-6">
                            <div class="single-form">
                                <label style="margin-right: 215px;">* Role</label>
                                <div class="select-option mb-10" style="margin-top: -32px;">
